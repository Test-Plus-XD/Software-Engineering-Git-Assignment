            ...
            <form onSubmit={handleSearchSubmit} className="space-y-4">
                ...
                <div className="flex flex-wrap gap-4 items-center">
                    ...
                    <div className="flex items-center gap-2">
                        <label htmlFor="label-filter" className="text-sm font-medium text-gray-700">
                            Filter by label:
                        </label>
                        <select
                            id="label-filter"
                            ...
                            className="px-3 py-1 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm"
                        ...
                        {labelsError && (
                            <span className="text-xs text-red-600" title={labelsError}>

...
describe('Creator and Editor Display', () => {
    ...
    test('should display creator information when available', async () => {
        ...
        expect(creatorInfo.textContent).toContain('john.doe@example.com');
    });
    ...
    test('should display last editor information when available', async () => {
        ...
        const creatorEditorInfo = screen.getByTestId('creator-editor-info');
        expect(creatorEditorInfo.textContent).toContain('jane.smith@example.com');
    });
    ...
    test('should display "Unknown" when creator information is not available', async () => {
        ...
        expect(screen.getByText(/Created by:/)).toBeInTheDocument();
        const creatorInfo = screen.getByTestId('creator-info');
        expect(creatorInfo.textContent).toContain('Unknown');
    });
